...
proto._summaryCollectedRx  = /^Seat\+([^:]+): (.+?) (\d+) +\[Does not show]$/i
proto._summaryShowedWonRx  = /^Seat\+([^:]+): (.+?) (\d+) +with ([^[]+) \[(..) (..)-.+]$/i
proto._summaryShowedLostRx = /^Seat\+([^:]+): (.+?) lose +with ([^[]+) \[(..) (..)-.+]$/i
proto._summaryFoldedRx     = /^Seat\+([^:]+): (.+?) Folded (before Flop|on the Flop|on the Turn|on the River)$/i
