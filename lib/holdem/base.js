...
proto._readHoleCards = function _readHoleCards (line, lineno) {
  ...
  this.hand.holecards = {
      card1: safeTrim(match[2])
    , card2: safeTrim(match[3])
    , metadata: {
        lineno: lineno
      , raw: line
    }
...
proto._readStreet = function _readStreet (line, lineno) {
  ...
  this.hand.board = {
      card1: safeTrim(match[2])
    , card2: safeTrim(match[3])
    , card3: safeTrim(match[4])
    , card4: safeTrim(match[5])
    , card5: safeTrim(match[6])
    , metadata: {
        lineno: lineno
      , raw: line
    }
...
proto._readBoard = function _readBoard (line, lineno) {
  ...
  this.hand.board = {
      card1: safeTrim(match[1])
    , card2: safeTrim(match[2])
    , card3: safeTrim(match[3])
    , card4: safeTrim(match[4])
    , card5: safeTrim(match[5])
    , metadata: {
        lineno: lineno
      , raw: line
    }
